# LLM Prompt
## CONTEXT
This is a widget project named 'timecard-widget' that the user described in the following: "timecard data visualization for calculating regular pay and ot pay for a given timeperiod".
...
– FileMaker file: TimeClock.fmp12
– Styles/examples: (none)
– Tech stack: React, TypeScript: disabled, State management: none.
